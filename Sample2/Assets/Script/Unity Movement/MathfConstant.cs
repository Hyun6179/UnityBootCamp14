...
public class MathfConstant : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 수학적 연산에 의해서 표현할 수 있는 최대의 수를 넘는 경우 자동으로 계산되는 값
        // 직접적으로 Infinity를 작성해 명시적으로 무한대를 표현하기도 합니다.
        // 1) Pow(0, -2) = 0^-2 = 1 / (0^2) = 1 / 0 (Infinity)
        // 2) float 범위로 표현할 수 없는 큰 수를 제곱하는 경우 
        ...
        // 2) 직접적으로 NegetiveInfinity가 명시되는 경우 
        ...
        // 허수 --> 음의 제곱근 Sqrt(-1)
        // 복소수 + a + bi 형태로 표현 
        // ※ C# System.Numberices.Complex 기능을 통해 허수에 대한 계산이 가능합니다.
        // using System.Numerics;
        // Complex c = Complex.Sqrt(-1);
        // 단점) 유니티 빌드 기준에 따라 사용이 제한 되는 경우가 있습니다(ex WebGL)
        ...
        //       계산이 더 간단하게 진행되고 따라서 유니티 등에서 사용되는 삼각 함수와 같은계산식에서
        //       사용됩니다.
        ...
        // 3. Mathf.Epsilon : float형에서 0이 아닌 가장 작은 양수값(거의 0에 가까운 값)
        //                --> 미세한 값을 다룰 때 사용하는 값.
