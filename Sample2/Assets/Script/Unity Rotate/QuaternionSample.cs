...
// upward : 방향을 바라보고 있을 때의 위 부분을 설정 (기본값은 up으로 설정되어있어서 특별한 경우 아니면 건드릴 일이 없음)
...
// Quaternion.RotateTowraeds(form, to, maxDegree) : 일정 각도만큼 점진적으로 회전을 처리합니다.
...
// 2. LookRotation(direction)의 경우는 회전 값만 계산하고 직접적인 적용은 하지 않습니다. -> 따라서 RotateTowards()를 사용해야함
